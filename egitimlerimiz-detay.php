				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					<aside>
						...
						<table class="egitim-detay_tablo">
							<tr>
								<th colspan="4">İndirim Politikamız</th>
							</tr>
							<tr>
								<td>PwC Müşterilerine Özel Fiyat</td>
								<?php 
									$indirim= $ucret  -	(($ucret * 20) / 100);
							...
							<tr>
							<?php 
									$indirim= $ucret  -	(($ucret * 35) / 100);

								?>
								<td>PwC Alumli'lerine Özel Fiyat</td>
								<td style="font-weight:bold"><?php echo number_format($indirim, 2, ',', '.'); ?> TL + KDV</td>
							</tr>
							<tr>
							<?php 
								...
								?>
								<td>STK / Öğrenci / Akademisyen Gruplarına Özel Fiyat</td>
								<td style="font-weight:bold"><?php echo number_format($indirim, 2, ',', '.'); ?> TL + KDV</td>
							</tr>
						</table>
						...
						<table class="egitim-detay_tablo">
							<tr>
								<th colspan="4">Toplu Alım Fiyat Politikamız</th>
							</tr>
							<tr>
								<td></td>
								<td>*10+ Alımlarda</td>
							...
							<tr>
								<td>PwC Müşterisi Olmayan</td>
								<?php 
									$indirim= $ucret  -	(($ucret * 15) / 100);
